...
const title = 'Conteneur a Enlever';
...
function displayEnlver(props, context) {
  context.setTitle(title);
  return (
    <div>
      <div className="col-lg-12">
        <PageHeader>Conteneur a Enlever</PageHeader>
      </div>

      <div className="col-lg-12">
        <Panel header={<span>Les des Manifest</span>} >
          <div>
...
displayEnlver.contextTypes = { setTitle: PropTypes.func.isRequired };
export default displayEnlver ;
